...
class IAlchemyLanguage(ILanguage):
    ...
    represent a language
    """
    ISO_639_1 = ValidTextLine(title="language iso-639-1 code", 
                              required=True)  # alias for code
    ISO_639_2 = ValidTextLine(title="language iso-639-2 code", 
                              required=False)
    ISO_639_3 = ValidTextLine(title="language iso-639-3 code", 
                              required=False)
    name = ValidTextLine(title="language name", required=False)
